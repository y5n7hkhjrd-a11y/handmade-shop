...
export default function AuthenticatedLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Mobile header bar */}
      <div className="lg:hidden relative overflow-hidden flex items-center gap-2.5 px-3 pt-[max(0.5rem,env(safe-area-inset-top))] pb-2 bg-gradient-to-r from-white via-pink-50/30 to-purple-50/30 border-b border-pink-100/60 sticky top-0 z-20 shadow-sm">
