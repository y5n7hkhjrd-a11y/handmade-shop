...
const DASHBOARD_SOCIAL_PLATFORMS: Array<{ key: string; label: string; icon: ReactNode; domain: string; phoneBased?: boolean }> = [
  {
    key: 'facebook',
    label: 'Facebook',
    icon: (
...
function SocialLinks({ customer, size = 'sm' }: { customer: any; size?: 'sm' | 'xs' }) {
  ...
  const hasAny = customer && (
    customer.facebook || customer.instagram || customer.tiktok || customer.threads || customer.phone
  );
            ...
            <div>
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-0.5">Chào mừng trở lại! Dưới đây là tình hình hôm nay.</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2.5">
