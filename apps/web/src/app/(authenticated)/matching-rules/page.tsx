            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-50">
                {rules.map((rule) => (
                  <tr
                    key={rule.id}
                    className="group hover:bg-purple-50/30 transition-colors duration-150"
                  >
                    <td className="px-5 py-4">
                      <code className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-mono font-semibold bg-purple-50 text-purple-700">
                        {rule.code}
                      </code>
                    </td>
                    <td className="px-5 py-4">
