...
main() {
  ...
  echo -e "DATABASE_URL_STAGING                 ${YELLOW}<staging PostgreSQL URL>${NC}"
  echo -e "DATABASE_URL_PROD                    ${YELLOW}<production PostgreSQL URL>${NC}"
  ...
  echo "   Add your GitHub project and set the 10 environment variables listed above."
  echo ""
